      ...
      <Box css={gridOuterContainerStyles}>
        ...
        <Box css={oledContainerStyles}>
          <Box css={oledColumnStyles}>
            ...
            {/* Transport, on the case under the knobs — real keys, not toolbar
              buttons. In external-sync mode the transport is not ours to
              drive, so the play key goes inert rather than disappearing. */}
            <Box css={transportKeysContainerStyles}>
              <TransportKey
              ...
              <TransportKey onPress={onReset}>
                <SkipPreviousIcon sx={{ fontSize: px(6) }} />
              </TransportKey>
              <TransportKey onPress={onClear}>
                <DeleteOutlineIcon sx={{ fontSize: px(6) }} />
              </TransportKey>
            </Box>
          </Box>
        </Box>
