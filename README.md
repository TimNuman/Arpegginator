...
- **Presets** -- the first Sound-mode page is a bank of 18 factory patches mixing classic-analog staples (FAT STACK, ACID LINE, RUBBER BASS, STARDUST, HOOVERCRAFT...) with NES and SID chip flavors (8-BIT HERO, PIPE DREAM, COIN GET, BREADBIN, SEWER GOBLIN...). Tap a cell or step with the right encoder to load; editing any parameter marks the patch EDITED (amber) and lights a reset cell that restores the preset.
