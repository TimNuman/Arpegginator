...
- **Presets** -- the first Sound-mode page is a bank of 25 factory patches mixing classic-analog staples (FAT STACK, ACID LINE, RUBBER BASS, STARDUST, HOOVERCRAFT...), NES and SID chip flavors (8-BIT HERO, PIPE DREAM, COIN GET, BREADBIN, SEWER GOBLIN...), and 4-op FM sounds (TINE MACHINE, CASTLE BELLS, MECHA BASS, RUST ORGAN...). Tap a cell or step with the right encoder to load; editing any parameter marks the patch EDITED (amber) and lights a reset cell that restores the preset.
